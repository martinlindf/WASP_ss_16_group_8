...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<object_loc>)))
  ...
  "a4453fe97d6d3223f879ac5a9613204a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'object_loc)))
  "Returns md5sum for a message object of type 'object_loc"
  "a4453fe97d6d3223f879ac5a9613204a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<object_loc>)))
  ...
  (cl:format cl:nil "#Custom message for publishing the detected object position~%#object_loc.msg~%int16 ID~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'object_loc)))
  "Returns full string definition for message of type 'object_loc"
  (cl:format cl:nil "#Custom message for publishing the detected object position~%#object_loc.msg~%int16 ID~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))

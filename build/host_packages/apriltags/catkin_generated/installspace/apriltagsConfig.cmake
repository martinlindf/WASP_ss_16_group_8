...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/wasp/catkin_ws/src/host_packages/apriltags)
...
if(NOT "include;/usr/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wasp/catkin_ws/install/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
